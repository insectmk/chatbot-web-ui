<template>
  <el-main>
    ...
    <el-row>
      <el-col :span="24">
        <el-input v-model="queryPageBean.queryString" placeholder="搭档名称" style="width: 200px;"></el-input>
      ...
      <el-col :span="24">
        <el-table
            ...
            <template slot-scope="props">
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                <el-form-item label="头像">
                  <!-- 图片的显示 -->
                  <img class="headImg" :alt="`搭档${props.row.username}的头像`" :src="props.row.head" width="70"/>
                </el-form-item>
                <el-form-item label="是否公开">
                  <el-tag type="success" size="small" v-if="props.row.isPublic">公开</el-tag>
                  <el-tag type="warning" size="small" v-else>私有</el-tag>
                </el-form-item>
              </el-form>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            <template slot-scope="props">
              <el-avatar shape="square" size="medium" :src="props.row.head"></el-avatar>
            </template>
          </el-table-column>
          <el-table-column
              prop="name"
...
<script>
import {findPartner, addUser, editUser, deleteUser} from '@/api'
...
export default {
  ...
  methods: {
    ...
    // 分页查询
    findPage() {
      return findPartner(this.queryPageBean).then(res => {
        if (res.data.flag) {
